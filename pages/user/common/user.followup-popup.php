<?php
/**
 * Follow-up thread popup — included on the user sessions page.
...
<div class="followup-popup" id="followupPopup">
    ...
    <div class="fu-session-list" id="followupSessionList">
        ...
        <div class="fu-popup-empty">
            ...
            <p>Threads open after your completed sessions.</p>
        </div>
        <?php else: ?>
            <?php foreach ($followupSessions as $fs): ?>
            <div class="fu-session-item"
                 data-session-id="<?= (int) $fs['sessionId'] ?>"
                 data-name="<?= htmlspecialchars($fs['counselorName']) ?>"
                 data-avatar="<?= htmlspecialchars($fs['counselorAvatar']) ?>"
                 data-date="<?= htmlspecialchars($fs['sessionDate']) ?>">
                <img src="<?= htmlspecialchars($fs['counselorAvatar']) ?>" alt="" />
                <div class="fu-session-item-info">
                    <p class="fu-session-item-name"><?= htmlspecialchars($fs['counselorName']) ?></p>
    ...
    <div class="fu-thread-view" id="followupThreadView">
        ...
        <div class="fu-thread-header">
            <button class="fu-back-btn" id="followupBackBtn" aria-label="Back">
            ...
            <div class="fu-thread-person">
                ...
                <div>
                    <h4 id="followupThreadName">Counselor</h4>
        ...
        <div id="followupCompose" class="fu-compose">
            <input type="text" id="followupInput" placeholder="Type a message…" maxlength="1000" />

<?php
$pageTitle = 'Edit Step 2 Question';
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" id="path" name="path">
                                <option value="BOTH" <?= $editQuestion['path'] === 'BOTH' ? 'selected' : '' ?>>Both</option>
                                <option value="LITE" <?= $editQuestion['path'] === 'LITE' ? 'selected' : '' ?>>Lite</option>
                                <option value="DEEP" <?= $editQuestion['path'] === 'DEEP' ? 'selected' : '' ?>>Deep</option>
                            </select>
                        </div>
                    </div>

...
<main class="admin-main-container">
    ...
    <section class="admin-main-content">
        ...
        <div class="admin-sub-container-2">
            ...
            <form method="POST" class="admin-form" id="addHelpCenterForm" novalidate style="max-width: 800px;">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-textarea" id="description" name="description" rows="5" required><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
            ...
            <script>
            document.getElementById('addHelpCenterForm').addEventListener('submit', function(e) {
                var valid = true;
                var fields = [

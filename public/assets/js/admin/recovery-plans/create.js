/**
 * Admin Recovery Plan Create - Form JavaScript
 * Merged with counselor form functionality
 */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const form = document.getElementById('createPlan-form') || document.getElementById('createPlanForm');
    if (form) {
    ...
    const targetDate = document.getElementById('targetCompletionDate');
    ...
    if (startDate) {
        ...
        startDate.addEventListener('change', function () {
            if (targetDate && targetDate.value && this.value > targetDate.value) {
                targetDate.value = '';
            }
            if (targetDate) targetDate.min = this.value;
        });
    }
});
...
function validateForm() {
    ...
    const startDate = document.getElementById('startDate');
    const endDate = document.getElementById('targetCompletionDate');
